...
| `father.nationalId` | parents.national_id | کد ملی پدر | section | digits | 10 digits + checksum | `^\d{10}$` | کد ملی پدر باید ۱۰ رقم باشد. |
...
| `student.nationalId` | students.national_id | کد ملی دانشآموز | always | digits | 10 digits + checksum | `^\d{10}$` + checksum | کد ملی باید ۱۰ رقم باشد. |
