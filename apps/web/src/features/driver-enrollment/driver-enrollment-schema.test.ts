...
const valid = {
  firstName:'علی',lastName:'رضایی',fatherName:'حسن',gender:'MALE',nationalId:'0084575948',phoneNumber:'09123456789',secondaryPhoneNumber:'',education:'DIPLOMA',homePhoneNumber:'',emergencyPhoneNumber:'09121111111',licenseExpiresAt:'2030-01-01',driverPhotoUploadId:'11111111-1111-4111-8111-111111111111',streetAddress:'تهران خیابان آزادی',postalCode:'1234567890',province:'تهران',city:'تهران',municipalityDistrict:'2',latitude:35.7,longitude:51.3,locationSelected:true,referrerName:'',referrerPhoneNumber:'',vehiclePhotoUploadId:'22222222-2222-4222-8222-222222222222',insuranceExpiresAt:'2030-01-01',vehicleType:'CAR',system:'سمند',modelYear:1400,technicalInspectionExpiresAt:'2030-01-01',plateLeft:'12',plateLetter:'ب',plateMiddle:'345',plateIran:'67',usageType:'PERSONAL',ownershipType:'SELF',contractFullyRead:true,contractAccepted:true,
} as const;
...
describe('driver enrollment validation', () => {
  ...
  it('accepts an optional mobile prefix and an eight-digit home phone', () => {
    expect(driverEnrollmentSchema.safeParse({ ...valid, secondaryPhoneNumber: '09', homePhoneNumber: '44225577' }).success).toBe(true);
  });
  it('rejects an eleven-digit home phone', () => {
    expect(driverEnrollmentSchema.safeParse({ ...valid, homePhoneNumber: '02144225577' }).success).toBe(false);
  });
