...
describe('driver enrollment validation', () => {
  ...
  it('rejects IBANs with fewer or more than 24 digits', () => {
    ...
    expect(driverEnrollmentSchema.safeParse({ ...valid, iban: `${valid.iban}5` }).success).toBe(false);
  });
