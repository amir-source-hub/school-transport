...
export async function restoreAdminDriver(id:string){return (await apiRequest(`/admin/drivers/${id}/restore`,{method:'POST'})).data;}
export async function permanentlyDeleteAdminDriver(id:string){return (await apiRequest(`/admin/drivers/${id}/permanent`,{method:'DELETE'})).data;}
