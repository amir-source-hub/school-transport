...
const steps = [
  ...
  [
    'انتخاب دانش‌آموز و مدرسه',
    'مشخصات تحصیلی، مدرسه و نوع سرویس دلخواه را انتخاب کنید.',
    ClipboardCheck,
  ],
  ['مرور و پذیرش قرارداد', 'همه جزئیات را شفاف ببینید و قرارداد را آنلاین بپذیرید.', FileText],
  [
    'پرداخت و شروع مسیر',
    'پیش‌پرداخت را انجام دهید و وضعیت درخواست را لحظه‌ای ببینید.',
    WalletCards,
  ],
] as const;
        ...
        <div className="grid items-center gap-12 lg:grid-cols-[.9fr_1.1fr]">
          ...
          >
            <div className="relative aspect-[5/4] overflow-hidden rounded-[1.45rem]">
              <Image
                src="/images/illustration-digital-route-safety-school-transport-ecosystem.webp"
                alt="خانواده، مدرسه و سرویس دانش‌آموزی"
                fill
          ...
          <div>
            ...
            <p className="mt-4 max-w-xl leading-7 text-muted">
              هر مرحله دقیقاً در جای خودش قرار دارد؛ اطلاعات را وارد می‌کنید، نتیجه را می‌بینید و
              همیشه می‌دانید قدم بعدی چیست.
            </p>
            <div className="relative mt-10 grid gap-4 sm:grid-cols-2">
              {steps.map(([title, description, Icon], index) => (
                ...
                >
                  <span className="absolute -left-2 -top-4 text-7xl font-black text-slate-100 transition group-hover:text-primary/5">
                    ۰{index + 1}
                  </span>
