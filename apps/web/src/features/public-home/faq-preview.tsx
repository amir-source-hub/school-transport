...
const faqs = [
  {
    ...
    answer:
      'وارد سامانه شوید، حساب خانواده ایجاد کنید، دانش‌آموز را اضافه کنید و اطلاعات مدرسه را وارد نمایید. سپس درخواست شما بررسی و قیمت‌گذاری می‌شود.',
    category: 'ثبت‌نام',
  },
  {
    question: 'هزینه سرویس مدرسه چقدر است و چطور محاسبه می‌شود؟',
    answer:
      'هزینه بر اساس مسافت، مدرسه، نوع سرویس و تعداد فرزندان محاسبه می‌شود. پس از ثبت درخواست، قیمت نهایی به شما اعلام خواهد شد.',
    category: 'قیمت‌گذاری',
  },
  {
    question: 'آیا می‌توانم چند دانش‌آموز را در یک حساب مدیریت کنم؟',
    answer:
      'بله. می‌توانید تمام فرزندان خود را در یک حساب خانواده مدیریت کنید و برای هر کدام به صورت جداگانه درخواست ثبت کنید.',
    category: 'حساب',
  },
  {
    question: 'روش‌های پرداخت کدامند؟',
    answer:
      'می‌توانید به صورت یک‌جا یا اقساطی و فعلاً از مسیر پرداخت آفلاین اقدام کنید. پرداخت آنلاین به‌زودی فعال می‌شود.',
    category: 'پرداخت',
  },
];
      ...
      <PageContainer>
        <div className="mx-auto max-w-3xl">
          <div className="text-center">
            ...
            <p className="mt-3 text-muted">سریع‌ترین راه برای پیدا کردن پاسخ سؤالات رایج.</p>
          </div>
