...
export function AdminFamilyEnrollmentForm({ family, schools }: { family: FamilyDetail; schools: SchoolOption[] }) {
  ...
  return (
    <form onSubmit={submit} className="space-y-6">
      ...
      <fieldset><legend className="mb-3 font-black">اطلاعات کامل والدین</legend><div className="grid gap-3 sm:grid-cols-2 lg:grid-cols-4">{textField('fatherFirst', 'نام پدر')}{textField('fatherLast', 'نام خانوادگی پدر')}{textField('fatherNationalId', 'کد ملی پدر', 'ltr')}{textField('fatherPhone', 'همراه پدر', 'ltr')}{textField('motherFirst', 'نام مادر')}{textField('motherLast', 'نام خانوادگی مادر')}{textField('motherNationalId', 'کد ملی مادر', 'ltr')}{textField('motherPhone', 'همراه مادر', 'ltr')}</div></fieldset>
