      ...
      <div className="flex flex-col gap-4 sm:flex-row sm:items-start sm:justify-between">
        ...
        {capacity.remaining > 0 ? (
          ...
          <p className="text-sm font-bold text-muted">
            ظرفیت حساب تکمیل است؛ مسئولیت پرداخت‌ها و تعهدات سرویس دانش‌آموزان ثبت‌شده بر عهده صاحب
            حساب خانواده است. برای ثبت دانش‌آموز جدید ابتدا درخواست افزایش ظرفیت ثبت کنید.
          </p>
        )}
      </div>
      {students.length === 0 && (
