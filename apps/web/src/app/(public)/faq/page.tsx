...
const questions = [
  {
    q: 'آیا یک خانواده می‌تواند چند دانش‌آموز ثبت کند؟',
    a: 'بله. یک حساب خانوادگی می‌تواند چند دانش‌آموز را مدیریت کند و اطلاعات، درخواست، قرارداد و پرداخت‌های هر دانش‌آموز جداگانه نگهداری می‌شود.',
    cat: 'حساب',
  },
  {
    q: 'قیمت سرویس چه زمانی مشخص می‌شود؟',
    a: 'قیمت ثابت عمومی در زمان ثبت‌نام وجود ندارد. مدیریت پس از بررسی درخواست و جزئیات خدمت، قیمت دوره کامل را تعیین می‌کند.',
    cat: 'قیمت',
  },
  {
    q: 'آیا ثبت درخواست به معنی تأیید سرویس است؟',
    a: 'خیر. درخواست پس از ارسال نیاز به بررسی مدیریت دارد و وضعیت تأیید، رد یا درخواست اصلاح در سامانه نمایش داده می‌شود.',
    cat: 'ثبت‌نام',
  },
  {
    q: 'چه روش‌های پرداختی وجود دارد؟',
    a: 'پرداخت آفلاین با بررسی مدیریت در دسترس است و پرداخت آنلاین به‌زودی فعال می‌شود. گزینه پرداخت کامل یا اقساطی طبق اطلاعات اعلام‌شده برای قرارداد نمایش داده خواهد شد.',
    cat: 'پرداخت',
  },
  {
    q: 'آیا می‌توان اطلاعات ثبت‌شده را ویرایش کرد؟',
    a: 'اطلاعات ساده و غیرعملیاتی در محدوده مجاز قابل ویرایش‌اند. اطلاعات حساس مانند مدرسه، خدمت تأییدشده، قیمت و وضعیت پرداخت تحت کنترل مدیریت باقی می‌مانند.',
    cat: 'ثبت‌نام',
  },
  {
    q: 'مدت زمان بررسی درخواست چقدر است؟',
    a: 'مدت زمان بررسی به حجم درخواست‌های مدیریت بستگی دارد و در اسرع وقت انجام می‌شود. وضعیت درخواست از طریق پنل خانواده قابل پیگیری است.',
    cat: 'ثبت‌نام',
  },
  {
    q: 'آیا امکان انصراف و استرداد وجه وجود دارد؟',
    a: 'شرایط انصراف و استرداد وجه بر اساس توافقات منعقدشده در قرارداد تعیین می‌شود. برای اطلاعات دقیق به متن قرارداد مراجعه کنید.',
    cat: 'پرداخت',
  },
];
        ...
        <PageContainer className="relative z-10">
          <div className="mx-auto max-w-3xl text-center">
            ...
            <p className="mt-4 text-lg text-white/60">
              سریع‌ترین راه برای پیدا کردن پاسخ سوالات رایج.
            </p>
          </div>
        </PageContainer>
      </section>
        ...
        <PageContainer>
          <div className="mx-auto max-w-xl">
            <div className="relative">
              <Search
                aria-hidden="true"
                className="absolute right-4 top-1/2 size-4 -translate-y-1/2 text-muted"
              />
              <Input
            ...
            {filtered.length === 0 ? (
              <div className="text-center py-12">
                ...
                <p className="mt-1 text-sm text-muted">
                  پرسشی با این کلمات در سامانه ثبت نشده است.
                </p>
              </div>
            ) : (
