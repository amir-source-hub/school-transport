...
import { BadgeCheck, HeartHandshake, Lock, MonitorSmartphone, Route, Headphones } from 'lucide-react';
...
const values = [
  { icon: BadgeCheck, title: 'شفاف برای خانواده', description: 'هر خانواده می‌تواند دانش‌آموزان خود را مدیریت کند و وضعیت هر کدام را جداگانه ببیند.' },
  { icon: Route, title: 'ساختارمند برای مدیریت', description: 'بررسی درخواست، تعیین قیمت و پرداخت در فرایندی مشخص و قابل پیگیری.' },
  { icon: HeartHandshake, title: 'متمرکز بر اعتماد', description: 'وضعیت‌ها و اقدام بعدی با زبان روشن و بدون پیچیدگی نمایش داده می‌شود.' },
  { icon: MonitorSmartphone, title: 'طراحی برای خانواده ایرانی', description: 'تجربه کاملاً فارسی، راست‌به‌چپ و واکنش‌گرا برای تلفن همراه.' },
  { icon: Lock, title: 'امنیت و حریم خصوصی', description: 'اطلاعات شخصی و مالی با پروتکل‌های امنیتی رمزنگاری می‌شود.' },
  { icon: Headphones, title: 'پشتیبانی پاسخگو', description: 'تیم پشتیبانی در ساعات اداری آماده پاسخگویی است.' },
];
  ...
  return (
    <>
      <section className="relative overflow-hidden surface-dark pb-20 pt-32 sm:pt-36">
        ...
        <PageContainer className="relative z-10">
          <div className="mx-auto max-w-3xl text-center">
            <Badge tone="info" className="mb-4 border-sun/30 bg-sun/15 text-sun backdrop-blur-sm">درباره ما</Badge>
            <h1 className="text-balance text-3xl font-black text-white sm:text-4xl">یک مسیر یکپارچه برای خانواده و مدیریت</h1>
            <p className="mt-4 text-lg text-white/60">سامانه‌ای برای ثبت و پیگیری خدمات سرویس مدرسه، از درخواست تا قرارداد و پرداخت.</p>
          </div>
        </PageContainer>
      </section>
        ...
        <PageContainer>
          <div className="lg:grid lg:grid-cols-2 lg:items-center lg:gap-12">
            ...
            <div>
              ...
              <h2 className="mt-2 text-2xl font-black">ایجاد شفافیت و سادگی در خدمات سرویس مدرسه</h2>
              <p className="mt-4 leading-relaxed text-muted">
                سامانه سرویس مدرسه با هدف ایجاد شفافیت و سادگی در فرایند ثبت‌نام، قرارداد و پرداخت
                خدمات سرویس مدرسه طراحی شده است. خانواده‌ها می‌توانند تمام مراحل را در یک سامانه دنبال
                کنند و مدیریت نیز ابزارهای لازم برای بررسی، قیمت‌گذاری و پیگیری را در اختیار دارد.
              </p>
              <div className="mt-6">
                <ButtonLink href="/contact" variant="secondary">ارتباط با ما</ButtonLink>
              </div>
            </div>
          </div>
        </PageContainer>
      ...
      <section className="surface-dark border-y border-white/10 py-16">
        <PageContainer>
          <div className="mx-auto max-w-3xl text-center">
            <Badge tone="info" className="bg-white/10 text-sun border-sun/20">اصول و ارزش‌ها</Badge>
        ...
        <PageContainer>
          <div className="lg:grid lg:grid-cols-2 lg:items-center lg:gap-12">
            <div>
              ...
              <div className="absolute right-1 top-0 h-full w-0.5 bg-primary-soft/50" aria-hidden="true" />
              {principles.map((p, i) => (
                <motion.div
                  key={p.year}
        ...
        <PageContainer>
          <div className="rounded-[var(--radius-canvas)] bg-gradient-to-br from-navy to-ink p-8 text-center sm:p-12">
            ...
            <div className="mt-6 flex flex-col items-center justify-center gap-3 sm:flex-row">
              <ButtonLink href="/contact" size="lg" className="bg-sun text-navy hover:bg-sun/90 shadow-lg shadow-sun/20">
                تماس با پشتیبانی
              </ButtonLink>
              <ButtonLink href="/faq" size="lg" variant="inverse" className="border-white/20 bg-white/10 backdrop-blur-sm">
                سوالات متداول
              </ButtonLink>
            </div>
          </div>
