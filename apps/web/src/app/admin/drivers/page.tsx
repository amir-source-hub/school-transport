...
export default async function Page() {
  ...
  return <div className="space-y-6"><Breadcrumbs items={[{ label: 'پنل مدیریت', href: '/admin/dashboard' }, { label: 'رانندگان' }]} />
    <header className="flex flex-wrap items-end justify-between gap-4"><div><h1 className="text-2xl font-black">رانندگان ثبت‌شده</h1><p className="mt-2 text-sm text-muted">پرونده واقعی راننده، خودرو، سرویس‌ها و دانش‌آموزان متصل</p></div><ExportReportButton path="/admin/reports/drivers.xlsx" label="خروجی Excel رانندگان" /></header>
