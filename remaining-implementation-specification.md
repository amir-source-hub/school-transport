...
- [ ] Add flow-specific PostgreSQL proofs for row locks, constraints, concurrent idempotency/authorization, notification migration, feedback, photo approval, and offline-payment finalization, plus a deployed-process smoke after those database cases pass. **[NOT FINISHED]**
