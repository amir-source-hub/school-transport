...
const matrix = JSON.parse(await readFile(resolve(import.meta.dirname, 'test-coverage-matrix.json'), 'utf8'));
const required = ['unit', 'component', 'integration-real-services', 'browser-e2e', 'accessibility', 'mobile-tablet', 'visual', 'performance', 'dependency-failure', 'regression-ci'];
